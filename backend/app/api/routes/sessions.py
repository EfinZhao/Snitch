...
async def create_session(body: SessionCreate, session: SessionDep, user: CurrentUserDep):
...
async def stream_session_events(session_id: int, request: Request, session: SessionDep, user: CurrentUserDep):
...
async def add_recipient(session_id: int, body: SessionRecipientAdd, session: SessionDep, user: CurrentUserDep):
    return await session_service.add_session_recipient(session, session_id, user, body)


@router.patch('/{session_id}', response_model=SessionRead)
async def update_session(session_id: int, body: SessionUpdate, session: SessionDep, user: CurrentUserDep):
